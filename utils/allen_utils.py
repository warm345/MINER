# The code is copied from allennlp lib for decreasing dependency of MINER.
# Please move to https://github.com/allenai/allennlp for more details.
...
class Token:
    ...
    def __init__(
        ...
        assert text is None or isinstance(
            text, str
        )  # Some very hard to conll_debug errors happen when this is not true.
        self.text = text
        self.idx = idx
...
if __name__ == "__main__":
    x = ["wx", "lives", "in", "Shanghai", "."]
    print(enumerate_spans(x, max_span_width=2))
